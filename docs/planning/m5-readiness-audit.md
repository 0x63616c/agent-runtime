...
- API-011: compatibility fixtures and migration guidance; API-012: production PostgreSQL admin lifecycle evidence and final combined authorization suite.
