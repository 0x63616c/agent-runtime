...
func TestOperationMatrixPublicTypesCompile(t *testing.T) {
	...
	requests := []sandbox.OperationRequest{
		...
		{ID: "op_copy_in", Kind: sandbox.OperationCopyIn, CopyIn: &sandbox.CopyInRequest{SandboxID: "sbx_01", Source: sandbox.ArtifactRef{ID: "art_01", MediaType: "application/octet-stream", SizeBytes: 1, Digest: "sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"}, Destination: "/work/in"}},
		{ID: "op_copy_out", Kind: sandbox.OperationCopyOut, CopyOut: &sandbox.CopyOutRequest{SandboxID: "sbx_01", Source: "/work/out", MediaType: "application/octet-stream"}},
