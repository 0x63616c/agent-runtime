...
var roleFixtures = []roleFixture{
	...
	{roles.RoleTool, roleConfig(roles.RoleTool, 8083, `[{"name":"telemetry","endpoint":"http://telemetry:4318"},{"name":"tool-broker","endpoint":"http://api:8080","secret_environment":"TOOL_BROKER_TOKEN"}]`), []string{"TOOL_BROKER_TOKEN"}},
