...
var _ = Describe("Operator role configuration", func() {
	...
	It("refuses dispatch authority in the trigger-only tool role", func() {
		...
		configuration = strings.TrimSuffix(configuration, "}") + `,"tool_dispatch":{"content_endpoint":"blob:9000","content_bucket":"runtime","content_access_key_environment":"TOOL_DISPATCH_CONTENT_ACCESS_KEY","content_secret_key_environment":"TOOL_DISPATCH_CONTENT_SECRET_KEY","control_server_name":"control.example.invalid","control_trust_bundle_ref":"trust/runtime","control_trust_bundle_path":"/var/run/trust/control.pem","control_credential_environment":"TOOL_DISPATCH_CONTROL_TOKEN"}}`
