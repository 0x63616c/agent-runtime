...
var _ = Describe("Self-hosted production Stack", func() {
	It("renders explicit trust-scoped roles, secrets, defaults, ingress, and operator dependencies", func() {
		...
		Expect(findResource(resources, "temporal").Kubernetes.Image).To(Equal("temporalio/auto-setup@sha256:b44cbfeb43dbeae42db113b44fb8414c3452f05643b3d6b1592f955277d73526"))
