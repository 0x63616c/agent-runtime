...
{"id":"blob-prefix","kind":"blob","owner":"blob-operator","scope":"namespace","dependencies":["blob-creds","blob-reconciler","blob-service"],"retention":%[1]s,"backup_restore_owner":"none","delete_behavior":"%[2]s","external_controller":false,"blob":{"bucket":"smoke-bucket","prefix":"smoke/payloads","endpoint_reference":"blob-service","credential_reference":"blob-creds","reconciler_reference":"blob-reconciler"}},
