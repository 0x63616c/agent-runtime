...
func (client minioImmutableClient) PutIfAbsent(ctx context.Context, bucket, key string, value []byte) (bool, error) {
...
func (client minioImmutableClient) Get(ctx context.Context, bucket, key string, maxBytes int) ([]byte, error) {
	object, err := client.client.GetObject(ctx, bucket, key, minio.GetObjectOptions{})
	if err != nil {
		return nil, err
	}
