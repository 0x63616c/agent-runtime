...
func TestParseStrictReferenceHostConfiguration(t *testing.T) {
	...
	if err != nil || config.hostID != "host_01" || config.hostGeneration != 2 || config.maximumReceipts != 100 {
