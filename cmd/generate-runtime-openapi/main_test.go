...
func validPaths() map[string]map[string]openapicontract.Operation {
	...
	return map[string]map[string]openapicontract.Operation{
		...
		"/v1/sessions/{session_id}/artifacts":                 {"get": {OperationID: "listSessionArtifacts", Parameters: parameters, Responses: responses}},
		"/v1/idempotency":                                     {"get": {OperationID: "idempotencyStatus", Parameters: mutationParameters, Responses: responses}},
		...
		"/v1/sessions/{session_id}/turns/{turn_id}/tools":     {"get": {OperationID: "inspectToolCalls", Parameters: parameters, Responses: responses}},
