...
func writeControlConfig(t *testing.T, directory, publicAddress, hostAddress string, identity identities) string {
	t.Helper()
	config := fmt.Sprintf(`{"version":1,"listen_address":%q,"tls_certificate_file":%q,"tls_private_key_file":%q,"database_dsn_environment":"TEST_DATABASE_DSN","authorization_environment":"TEST_AUTHORIZATION","assertion_key_environment":"TEST_ASSERTION_KEY","identity":{"authority":"integration","tenant":"tenant_01","subject":"runtime_01","principal":"tenant_01:runtime_01"},"binding_lifetime_seconds":60,"retention_seconds":3600,"wait_interval_millis":10,"reconciliation_interval_millis":1000,"reconciliation_page_size":100,"admission":{"version":"policy-v1","canonicalizer_version":"sandbox.control/v1","capability_version":"capabilities-v1","image_admission_version":"images-v1","defaults":{"milli_cpu":100,"memory_bytes":1024,"root_disk_bytes":1024,"tmpfs_bytes":1024,"pids":10,"process_count":10,"open_files":10,"inodes":10,"files":10,"lifetime_seconds":60,"produced_output_bytes":1024,"retained_output_bytes":1024,"transfer_bytes":1024,"network_connections":10,"volume_bytes":1024,"snapshot_bytes":1024},"maximum":{"milli_cpu":1000,"memory_bytes":1048576,"root_disk_bytes":1048576,"tmpfs_bytes":1048576,"pids":100,"process_count":100,"open_files":100,"inodes":100,"files":100,"lifetime_seconds":3600,"produced_output_bytes":1048576,"retained_output_bytes":1048576,"transfer_bytes":1048576,"network_connections":100,"volume_bytes":1048576,"snapshot_bytes":1048576},"capabilities":{},"admitted_images":{}},"host_control":{"listen_address":%q,"tls_certificate_file":%q,"tls_private_key_file":%q,"client_ca_file":%q,"control_key_id":"control_01","control_signing_key_environment":"TEST_CONTROL_SIGNING_KEY","lease_seconds":60}}`, publicAddress, identity.publicCertificate, identity.publicKey, hostAddress, identity.hostServerCertificate, identity.hostServerKey, filepath.Join(directory, "ca.crt"))
...
func writeHostConfig(t *testing.T, directory, name, address string, identity identities, generation uint64, journal string, faultAfterJournal, faultAfterReceipt, faultAfterResultSend bool) string {
	...
	config := fmt.Sprintf(`{"version":1,"control_url":%q,"server_name":"localhost","trust_bundle_file":%q,"client_certificate_file":%q,"client_private_key_file":%q,"host_id":"host_01","host_generation":%d,"journal_file":%q,"maximum_receipts":100,"control_key_id":"control_01","control_public_key_environment":"TEST_CONTROL_PUBLIC_KEY","host_signing_key_environment":"TEST_HOST_SIGNING_KEY","request_timeout_seconds":5,"test_fault_after_journal":%t,"test_fault_after_receipt":%t,"test_fault_after_result_send":%t}`, "https://"+address, filepath.Join(directory, "ca.crt"), certificate, key, generation, journal, faultAfterJournal, faultAfterReceipt, faultAfterResultSend)
