...
route constants are checked against its eleven operations.
...
The API creates and reads immutable Agent revisions, creates and inspects
...
catalog operations require a tenant administrator. Session access is scoped to
