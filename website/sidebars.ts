...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    {type: 'category', label: 'Reference', items: ['reference/overview', 'reference/temporal-payloads', 'reference/sandbox-control-ledger', 'reference/generated/source-inventory']},
