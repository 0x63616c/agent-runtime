...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    {type: 'category', label: 'Reference', items: ['reference/overview', 'reference/runtime-go-contract', 'reference/runtime-http-api', 'reference/postgresql-data-authority', 'reference/temporal-payloads', 'reference/sandbox-control-ledger', 'reference/sandbox-host-control', 'reference/generated/source-inventory']},
