...
go test -race -tags=integration ./internal/runtimeapi ./internal/runtimeapiprocess ./internal/runtimemodel ./internal/runtimeorchestration ./internal/runtimetool ./examples/durable-chat -run 'Test(DurableStateRuntimeAuthorizesArtifactInputReferences|DurablePostgresMinIOCollectorDeletesExpiredUnreferencedArtifact|DurablePostgresMinIOTenantErasurePreservesAnotherTenant|DurablePostgresMinIOAPIProcessSurvivesRestart|DurableModelProducerLossFinalizesGapAndReplays|DurableModelNormalizedStreamFinalizesOwnerReadableOutput|CodecEnabledWorkerStartsAgainstDurableDependenciesAndRestarts|PostgresOutboxReclaimsLiveTemporalRouteAfterAcknowledgementLoss|PostgresOutboxRecoversAcrossActualPublisherProcessKills|PostgresOutboxReclaimsAuditExportAfterSinkOutage|SessionWorkflowReplaysCheckedInHistoricLifecycle|DurableToolLifecyclePersistsDescriptorApprovalAndFinalization|DurableChatReconnectsAndCancelsThroughRestartedDurableAPIProcess|DurableChatTerminalAndWebBinariesUseOnlyPublicPathAcrossRestart)' -count=1
